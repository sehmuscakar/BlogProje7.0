...
namespace BlogProjeCore7._0.Areas.Admin.Controllers
{
    ...
    public class PostsController : Controller
    {
        ...
        {
            ViewData["CategoryId"] = new SelectList(_context.Categories, "Id", "Name");//name dedik listelenirken ismi gelecek 
            return View();
        }
        ...
        public async Task<IActionResult> Create(Post post, IFormFile? Image)
        {
            if (ModelState.IsValid)
            {
                if (Image is not null)
                {
                    ...
                    post.Image = Image.FileName; //burda da veritabanına atadı propert olarak tanımladığı kısıma db de 
                }
                _context.Add(post);

...
{
    [Area("Admin")] //Authorize controllerları güvene alıyoruz
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create(Category category,IFormFile? Image) //dosya yukleme işlemi için IFormFile? Image ekledik Image ismi 
        {
            if (ModelState.IsValid)
            {
              ...
              Image.CopyTo(stream);// dosya yuklendi
                    category.Image = Image.FileName; //burda da veritabanına atadı propert olarak tanımladığı kısıma db de 
                }
